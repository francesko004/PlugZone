...
class DisputesController extends Controller
{
    ...
    {
        $disputes = Dispute::getUserDisputes(Auth::id())->paginate(10);
    ...
    {
        // Query all disputes, ordering by created_at descending with pagination
        $disputes = Dispute::getAllDisputes()->paginate(16);
    ...
    {
        $disputes = Dispute::getVendorDisputes(Auth::id())->paginate(10);
