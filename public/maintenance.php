...
<body>
    <div class="maintenance-container">
        ...
        <h1 class="maintenance-title">PlugZone Under Maintenance</h1>
        <p class="maintenance-message">
            We are currently performing scheduled maintenance. Our team is working to bring PlugZone back online as soon as possible.
        </p>
